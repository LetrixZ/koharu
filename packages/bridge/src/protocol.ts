...
export const commands = {
	...
	getApiSettings: () => __TAURI_INVOKE<ApiSettings>("get_api_settings"),
	applyApiSettings: (enabled: boolean, port: number, host: string, token: CredentialInput) => __TAURI_INVOKE<ApiSettings>("apply_api_settings", { enabled, port, host, token }),
